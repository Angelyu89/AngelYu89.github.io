...
//						 //计算出相差天数  
						...
						$('#result-show').html(hours+"小时 "+minutes+"分");
...
//场地预定--场地详情
$(".setlistbox").on("tap",".set_placeId",function(){
	var placeId = $(this).attr("id");
	
	window.location.href="site-xq.html?placeId="+placeId;
...
$(".renlistboxy").on("tap",".rent-office-yuyuanbox",function(){
	window.location.href ="rent-office-xq.html";
})
