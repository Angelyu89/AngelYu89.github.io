	...
	function activityList(){
		...
		$.ajax({
			...
			success:function(res){
				...
				//空间推荐		
//					str += '<div class="home-cenction-box">'+
//						'<h5>空间推荐</h5>'+
//						'<div class="home-gengduo01">'+
//							'<a href="">更多'+
//								'<img src="images/img3333_07.png" alt="" />'+
//							'</a>'+			
//						'</div>'+
//						'<div class="home-cion-img">'+
//							'<a href="">'+
				...
				for(var i=0; i<data.length; i++){		
					str +='<div class="home-cion-img">'+
							...
							'<div class="home-cion-jc-ip">'+
									'<span class="">'+data[i].address+'</span>'+
									'<span class="home-icon-time">'+data[i].startTime+'</span>'+
								'</div>'+
							'</a>'+
						'</div>'+
						'<div class="home-cion-ip">'+
									...
									'<li>'+
										'<a href="">'+
											...
											'<div class="li-rg">'+
												...
												'<div class="li-ip">'+data[i].address+'</div>'+
...
//              		var str = '';
//					
//						var data = res.data.activityList.result;
//							//精彩活动
//						for(var i=0; i<data.length; i++){		
//							str +='<div class="home-cion-img">'+
//									'<a href="">'+
				...
				console.log(res);
					...
					var str = '';
						...
						for(var i=0;i<data.length;i++){
							...
							var d = new Date();
				              d.setTime(data[i].enrollStartTime);
...
//								console.log(newsetTime);
								...
								var c = new Date();
				              c.setTime(data[i].enrollEndTime);
...
//								console.log(newendTime);
							...
							if(data[i].canSignup=="off"){
								...
								'<div class="long-rent-nav-img-box rent-office-yuyuanbox">'+
									'<div class="acXqBtn">'+
										'<img id='+data[i].activityID+' canSignup='+data[i].canSignup+' src='+data[i].image3+' alt="" />'+
									'</div>'+
